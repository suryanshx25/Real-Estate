...
st.set_page_config(page_title="Analytics to Gain Insights about Gurgaon Properties and Trends")

st.title('Analytics')

new_df = pd.read_csv('datasets/data_viz1.csv')
feature_text = pd.read_pickle('datasets/feature_text.pkl')
...
wordcloud = WordCloud(width=800,
                      ...
                      stopwords=set(['s']),  # Exclude specific stopwords
